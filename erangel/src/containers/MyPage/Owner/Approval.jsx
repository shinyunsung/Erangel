...
import ApprovalList from "../../../conponents/Mypage/ApprovalList";
class Approval extends Component {
  ...
  _getList() {
    const apiUrl = "dummy/ApprovalList.json";
    axios
      .get(apiUrl)
      .then((data) => {
        this.setState({
    ...
    return (
      <div className="container">
        ...
        <Wrapper>
          ...
          <ApprovalList ApprovalList={this.state.ApprovalList}> </ApprovalList>
        </Wrapper>
      </div>
    );
  }
